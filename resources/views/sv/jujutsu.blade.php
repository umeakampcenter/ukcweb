...
<a href="https://www.facebook.com/groups/ukcjutsu/" target="_blank" class="external-link">
    <div><img src="images/fb.png" /></div><span>Facebookgrupp</span>
</a>
<a href="https://www.instagram.com/jujutsu.umea" target="_blank" class="external-link">
    <div><img src="images/instagram.png" /></div><span>Instagram</span>
</a>
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/juju_ny1.jpg') }}" alt="Jujutsu - hiji gatame">
@endslot
@endcomponent
@component('contentBox')
@slot('textBox')
...
@endslot
@slot('imageBox')
<iframe width="100%" height="315" src="https://www.youtube.com/embed/NFSAuNPZpOY?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen>
</iframe>
@endslot
@endcomponent
@component('contentBox')
...
@endslot
@slot('imageBox')
<iframe width="100%" height="315" src="https://www.youtube.com/embed/O2TI7xZ4TK8?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen>
</iframe>
@endslot
@endcomponent
@component('contentBox')
...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/juju_ny3.jpg') }}" alt="Jujutsu och bjj går bra ihop på bild Juji gatame ">
@endslot
@endcomponent
@component('contentBox')
@slot('textBox')
...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/juju_ny2.jpg') }}" alt="Jujutsu - Hiza geri">
@endslot
@endcomponent
@component('instructors', ['persons' => [
[
'imageUrl' => Vite::asset('resources/images/instructors/peter.jpg'),
'name' => 'Peter Spegel, Renshi',
'phone' => config('app.phoneNumbers.pspegel'),
'belt' => '|||||'
],
[
'imageUrl' => Vite::asset('resources/images/instructors/arvid.jpg'),
'name' => 'Arvid Edberg, Sensei',
'phone' => config('app.phoneNumbers.aedberg'),
'belt' => '||'
],
[
'imageUrl' => Vite::asset('resources/images/instructors/john.jpg'),
