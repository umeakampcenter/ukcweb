...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/selfdef1.jpg') }}" alt="Umeå Kampcenter">
@endslot
@endcomponent
@component('contentBox')
@slot('textBox')
...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/selfdef2.jpg') }}" alt="Umeå Kampcenter">
@endslot
@endcomponent
@component('contentBox')
@slot('textBox')
...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/selfdef.jpg') }}" alt="Umeå Kampcenter">
@endslot
@endcomponent
