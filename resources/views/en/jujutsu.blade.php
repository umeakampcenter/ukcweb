...
<a href="https://www.facebook.com/groups/ukcjutsu/" target="_blank" class="external-link">
    <div><img src="images/fb.png" /></div><span>Facebook group</span>
</a>
...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/juju_ny1.jpg') }}" alt="Umeå Kampcenter">
@endslot
@endcomponent
@component('contentBox')
@slot('textBox')
...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/juju_ny3.jpg') }}" alt="Umeå Kampcenter">
@endslot
@endcomponent
@component('contentBox')
@slot('textBox')
...
@endslot
@slot('imageBox')
<img src="{{ Vite::asset('resources/images/juju_ny2.jpg') }}" alt="Umeå Kampcenter">
@endslot
@endcomponent
